...
фиксировать должностные оклады для каждой должности и дни отпуска*/
    ...
    public static void num3(String[] args) {
        int[] arr6 = new int[]{12,51,56,16,19,20,25};
        addElement(arr6);
    }
    public  static int[] addElement(int[] arr)
    {
        ...
        System.out.print("Введите число для вставки в массив: ");
        int elem = in.nextInt();
        System.out.print("Введите позицию для вставки в массив: ");
        int pos = in.nextInt();
        int[] after = new int[arr.length+1];
        System.arraycopy(arr,0,after,0,pos);
        after[pos-1]=elem;
        System.arraycopy(arr,pos,after,pos,arr.length - pos);
