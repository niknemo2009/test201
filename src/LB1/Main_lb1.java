...
public class Main_lb1 {

    public static void main(String[] args) {
        Main_lb1 m = new Main_lb1();
        ...
        System.out.println(Arrays.toString(m.deleteArray(arr)));
        //
    ...
    public int[] deleteArray(int[] arr)
    {//1
    ...
    public void combinationArr(int[] arr3, int[] arr4)
    {//4
